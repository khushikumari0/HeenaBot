...
if ((event.body.toLowerCase() == "put") || (event.body.toLowerCase() == "Putt")) {
  ...
  if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "🥰🥰") || (event.body.toLowerCase() == "🥰🥰🥰") || (event.body.toLowerCase() == "🥰🥰🥰🥰")) {
     return api.sendMessage("topa गिरी mat dikha😑", threadID);
   };
...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "raj") || (event.body.toLowerCase() == "RAJ") || (event.body.toLowerCase() == "राज") || (event.body.toLowerCase() == "राज")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:-☞RAJ☜💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐁𝐢𝐭𝐭𝐮 \n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/share/19QuHckTb5/\n👋For Any Kind Of Help Contact On Instagram Username 👉https://instagram.com/_raj xd__?igshid=OGQ5ZDc2ODk2ZA==😇", threadID);
   };
